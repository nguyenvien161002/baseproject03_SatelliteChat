...
import com.example.satellitechat.services.remote.agora.media.AccessToken2.ServiceRtc

class RtcTokenBuilder2 {
    enum class Role(var initValue: Int) {
    ...
    fun buildTokenWithUserAccount(
        ...
        val serviceRtc: AccessToken2.Service = ServiceRtc(channelName, account)
     ...
     */
    fun buildTokenWithUid(
        appId: String?, appCertificate: String?, channelName: String?, uid: Int,
        tokenExpire: Int, joinChannelPrivilegeExpire: Int, pubAudioPrivilegeExpire: Int,
        pubVideoPrivilegeExpire: Int, pubDataStreamPrivilegeExpire: Int
    ): String {
        return buildTokenWithUserAccount(
            appId,
            appCertificate,
     ...
     */
    fun buildTokenWithUserAccount(
        appId: String?, appCertificate: String?, channelName: String?, account: String?,
        tokenExpire: Int, joinChannelPrivilegeExpire: Int, pubAudioPrivilegeExpire: Int,
        pubVideoPrivilegeExpire: Int, pubDataStreamPrivilegeExpire: Int
    ): String {
